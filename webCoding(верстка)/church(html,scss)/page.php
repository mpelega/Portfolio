...
js/vendor/modernizr-2.6.1-respond-1.1.0.min.js"></script>
    </head>
    <body>
        <!--[if lt IE 7]>
...
images/logo.png" alt="travel html5 template" title="travel html5 template">
                                </a>
                            </div> <!-- /.logo -->
                        </div> <!-- /.col-md-4 -->
        ...
        <div class="flexslider">
            <ul class="slides">
                <li>
                    ...
                    <img src="<?php  bloginfo("template_directory"); ?>/
images/templatemo_slide_1.jpg" alt="Special 1">
                    <div class="container">
                        <div class="row">
                ...
                <li>
                    <div class="overlay"></div>
                    <img src="<?php  bloginfo("template_directory"); ?>/
images/templatemo_slide_2.jpg" alt="Special 2">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-lg-4">
                                <div class="flex-caption visible-lg">
                ...
                <li>
                    <div class="overlay"></div>
                    <img src="<?php  bloginfo("template_directory"); ?>/
images/templatemo_slide_3.jpg" alt="Special 3">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-lg-4">
                                <div class="flex-caption visible-lg">
                ...
                <div class="our-listing owl-carousel">
                    <div class="list-item">
                        <div class="list-thumb">
                            ...
                            <img src="<?php  bloginfo("template_directory"); ?>/
images/destination_1.jpg" alt="destination 1">
                        </div> <!-- /.list-thumb -->
                    ...
                    <div class="list-item">
                        <div class="list-thumb">
                            ...
                            <img src="<?php  bloginfo("template_directory"); ?>/
images/destination_2.jpg" alt="destination 2">
                        </div> <!-- /.list-thumb -->
                        <div class="list-content">
                    ...
                    <div class="list-item">
                        <div class="list-thumb">
                            ...
                            <img src="<?php  bloginfo("template_directory"); ?>/
images/destination_3.jpg" alt="destination 3">
                        </div> <!-- /.list-thumb -->
                        <div class="list-content">
                    ...
                    <div class="list-item">
                        <div class="list-thumb">
                            ...
                            <img src="<?php  bloginfo("template_directory"); ?>/
images/destination_4.jpg" alt="destination 4">
                        </div> <!-- /.list-thumb -->
                        <div class="list-content">
                    ...
                    <div class="list-item">
                        <div class="list-thumb">
                            ...
                            <img src="<?php  bloginfo("template_directory"); ?>/
images/destination_5.jpg" alt="destination 5">
                        </div> <!-- /.list-thumb -->
                        <div class="list-content">
                    ...
                    <div class="list-item">
                        <div class="list-thumb">
                            ...
                            <img src="<?php  bloginfo("template_directory"); ?>/
images/destination_6.jpg" alt="destination 6">
                        </div> <!-- /.list-thumb -->
                        <div class="list-content">
                ...
                <div class="row">
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <div class="partner-item">
                            <img src="<?php  bloginfo("template_directory"); ?>/
images/partners/partner1.png" alt="">
                        </div> <!-- /.partner-item -->
                    </div> <!-- /.col-md-2 -->
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <div class="partner-item">
                            <img src="<?php  bloginfo("template_directory"); ?>/
images/partners/partner2.png" alt="">
                        </div> <!-- /.partner-item -->
                    </div> <!-- /.col-md-2 -->
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <div class="partner-item">
                            <img src="<?php  bloginfo("template_directory"); ?>/
images/partners/partner3.png" alt="">
                        </div> <!-- /.partner-item -->
                    </div> <!-- /.col-md-2 -->
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <div class="partner-item">
